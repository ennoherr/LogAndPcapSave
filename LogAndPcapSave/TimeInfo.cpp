...
unsigned long TimeInfo::getTimestamp(void)
{
...
long long TimeInfo::getTimestampMs(void)
{
	std::chrono::milliseconds ms = std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now().time_since_epoch());
	return ms.count();
}

std::string TimeInfo::getTimeReadable(std::string DateTimeSep, std::string TimeSep)
{
	std::string res = "";
	const int l = 64;
...
std::wstring TimeInfo::getTimeReadableW(std::wstring DateTimeSep, std::wstring TimeSep)
{
	std::wstring res = L"";
	const int l = 64;
...
std::string TimeInfo::getTimeReadableMs(std::string DateTimeSep, std::string TimeSep, std::string MSecSep)
{
	std::string res = "";
	std::string msec = "";
...
std::wstring TimeInfo::getTimeReadableMsW(std::wstring DateTimeSep, std::wstring TimeSep, std::wstring MSecSep)
{
	std::wstring res = L"";
	std::wstring msec = L"";
